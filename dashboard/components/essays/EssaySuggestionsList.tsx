          ...
          <button
            ...
            className={`px-3 py-1 rounded-md text-xs font-medium transition-colors ${
              filterType === "all"
                ...
                : "bg-[#2a2a2a]/40 backdrop-blur-sm border border-white/10 text-white/70 hover:text-white"
            }`}
          >
            All Types
          </button>
      ...
      <div className="space-y-3">
        {filteredSuggestions.length > 0 ? (
          filteredSuggestions.map((suggestion, index) => (
            <div
              key={index}
              className="bg-[#2a2a2a]/30 backdrop-blur-xl border border-white/10 rounded-md p-4 hover:border-white/20 transition-all"
            >
                ...
                <div className="flex-1">
                  ...
                  {suggestion.currentText && (
                    <div className="mb-2">
                      ...
                      <div className="bg-[#2a2a2a]/40 backdrop-blur-sm border border-white/10 rounded-md px-3 py-2 text-sm text-white/70">
                        {suggestion.currentText}
                      </div>
                    </div>
                  )}
                  ...
                  {suggestion.suggestedText && (
                    <div>
                      ...
                      <div className="bg-[#2a2a2a]/40 backdrop-blur-sm border border-[#00ffff]/50 rounded-md px-3 py-2 text-sm text-[#00ffff]">
                        {suggestion.suggestedText}
                      </div>
                    </div>
                  )}

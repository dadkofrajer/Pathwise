...
export default function EssayCard({ essay, onEdit, onDelete }: EssayCardProps) {
  ...
  return (
    <div className="bg-[#2a2a2a]/30 backdrop-blur-xl border border-white/10 rounded-md p-6 hover:border-[#00ffff]/30 transition-all duration-200">
      <div className="mb-4">
        <div className="flex items-start justify-between mb-2">
          <h3 className="text-white text-base font-bold flex-1">{essay.title}</h3>
          {essay.collegeName && (
            <span className="px-2 py-0.5 bg-[#2a2a2a]/40 backdrop-blur-sm border border-[#00ffff]/50 rounded-md text-xs text-[#00ffff] ml-2 font-medium">
      ...
      <div className="mb-4">
        ...
        <div className="w-full bg-[#2a2a2a]/40 backdrop-blur-sm rounded-full h-1.5 overflow-hidden border border-white/5">
          <div
        ...
        <div className="flex items-center gap-2">
          ...
          {onDelete && (
            <button
              ...
              className="flex items-center gap-2 bg-[#2a2a2a]/40 backdrop-blur-sm border border-white/10 text-white/70 px-4 py-2 rounded-md hover:border-[#ff00ff]/50 hover:text-[#ff00ff] transition-all duration-200 text-sm font-medium"
